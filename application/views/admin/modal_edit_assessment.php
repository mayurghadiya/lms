    ...
    <div class=col-lg-12>
        ...
        <div class="panel panel-default toggle panelMove panelClose panelRefresh">
            ...
            <div class=panel-heading>
                <h4 class=panel-title>  <?php echo ucwords("Update assessment");?></h4>                
            </div> 
                <div class="panel-body">
                    <div class="tab-pane box" id="add" style="padding: 5px">
                        <div class="box-content">  
                            ...
                            <?php echo form_open(base_url() . 'admin/assessments/update/' . $row['assessment_id'], array('class' => 'form-horizontal form-groups-bordered validate', 'id' => 'frmeditassignment', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
...
<script type="text/javascript">
    ...
    $("#semester1").change(function (event) {
        ...
        var dataString = "course=" + course + "&degree=" + degree+"&batch="+batch+"&semester="+semester;
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() . 'admin/checkassignment/'.$param2; ?>",          
                data:dataString,
     ...
     $("#semester1").change(function(){
        ...
        var dataString = "course=" + course + "&degree=" + degree+"&batch="+batch+"&semester="+semester;
            $.ajax({
                    type: "POST",
                    url: "<?php echo base_url() . 'admin/get_assessment_student'; ?>",
                    data: dataString,
