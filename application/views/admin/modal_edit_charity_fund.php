<?php
$edit = $this->db->get_where('charity_fund', [
            'charity_fund_id' => $param2
        ])->row();
?>
<div class=row>                      
    ...
    <div class=col-lg-12>
        ...
        <div class="panel panel-default toggle panelMove panelClose panelRefresh">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'admin/charity_fund/update/' . $edit->charity_fund_id, array('class' => 'form-horizontal form-groups-bordered validate', 'role' => 'form', 'id' => 'chartiyfund', 'target' => '_top')); ?>
