...
$reopen_student = $this->Crud_model->get_student_reopen($param2);
        ...
        <div class="panel-default toggle panelMove panelClose panelRefresh">
                    <div class="tab-pane box" id="add" style="padding: 5px">
                        <div class="box-content">  
                            ...
                            <?php echo form_open(base_url() . 'admin/assignment/reopen/' . $param2, array('class' => 'form-horizontal form-groups-bordered validate', 'id' => 'frmeditproject', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
