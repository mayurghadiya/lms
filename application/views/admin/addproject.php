        ...
        <div class="panel-default toggle panelMove panelClose panelRefresh">
            ...
            <div class="panel-body"> 
                ...
                <div class="box-content">  
                    ...
                    <?php echo form_open(base_url() . 'admin/project/create', array('class' => 'form-horizontal form-groups-bordered validate', 'role' => 'form', 'id' => 'frmproject', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                    <div class="padded">
...
<script type="text/javascript">
    ...
    function get_student2(batch, semester = '') {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>admin/batchwisestudentcheckbox/',
            type: 'POST',
    ...
    $("#btnadd").click(function (event) {
        if ($("#degree").val() != null & $("#course").val() != null & $("#batch").val() != null & $("#semester").val() != null & $("#title").val() != null)
        {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() . 'admin/checkprjects'; ?>",
                dataType: 'json',
                data:
                        {
                            'degree': $("#degree").val(),
