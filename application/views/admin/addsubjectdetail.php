        ...
        <div class="panel-default toggle panelMove panelClose panelRefresh">
            ...
            <div class="panel-body"> 
                ...
                <div class="box-content"> 
                    ...
                    <?php echo form_open(base_url() . 'admin/subject_detail/create/'.$this->uri->segment(4), array('class' => 'form-horizontal form-groups-bordered validate', 'role' => 'form', 'id' => 'frmsubjectdetail', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                    <div class="padded">	
