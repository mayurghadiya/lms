                ...
                <div class="panel-body">
                    <div class="tab-pane box" id="add" style="padding: 5px">
                        <div class="box-content">  
                            ...
                            <?php echo form_open(base_url() . 'admin/project/do_update/' . $row['pm_id'], array('class' => 'form-horizontal form-groups-bordered validate', 'id' => 'frmeditproject', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
...
<script type="text/javascript">
    ...
    $( "#btnupd" ).click(function( event ) {
         ...
         $.ajax({
                    type:"POST",
                    url:"<?php echo base_url().'admin/checkprjectsedit/'.$param2; ?>",
                    dataType:'json',
                   data:
                        {
                            'degree':$("#degree2").val(),
    ...
    function get_student(batch, semester = '') {
       var batch = $("#batch2").val();
        ...
        $.ajax({
           url: '<?php echo base_url(); ?>admin/batchwisestudentcheckbox/'+param,
           type: 'POST',
    ...
    function get_students(divclass)
    {
       ...
       var batch = $("#batch2").val();
        var course = $("#course2").val();
         ...
         $.ajax({
           url: '<?php echo base_url(); ?>admin/checkboxstudent/'+param,
           type: 'POST',
