              ...
              // print_r($assessment);
               ...
               ?>
                ...
                <div class="box-content">                    
                    ...
                    <?php echo form_open(base_url() . 'admin/assessments/submitted/'.$assessment[0]->assignment_submit_id, array('class' => 'form-horizontal form-groups-bordered validate', 'role' => 'form', 'id' => 'frmassignment', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                    <div class="padded">    
