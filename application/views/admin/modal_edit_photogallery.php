        ...
        <div class=col-lg-12>
            ...
            <div class="panel-default toggle panelMove panelClose panelRefresh">
                ...
                <!--            <div class=panel-heading>
                                    <h4 class=panel-title>  <?php echo ucwords("Update Photo Gallery"); ?></h4>                
                                </div> -->
                <div class="panel-body">
                    <div class="">
                        ...
                        <?php echo form_open(base_url() . 'admin/photogallery/do_update/' . $row['gallery_id'], array('class' => 'form-horizontal form-groups-bordered validate', 'role' => 'form', 'id' => 'frmgallery2', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                        <div class="padded">											
