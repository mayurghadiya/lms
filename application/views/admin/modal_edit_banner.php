            ...
            <div class="panel-default toggle panelMove panelClose panelRefresh">
                ...
                <div class="panel-body">
                    <div class="">
                        ...
                        <?php echo form_open(base_url() . 'admin/bannerslider/do_update/' . $row['banner_id'], array('class' => 'form-horizontal form-groups-bordered validate', 'role' => 'form', 'id' => 'frmgallery2', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                        <div class="padded">											
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select name="slide_option" class="form-control">
                                        ...
                                        if ($row['slide_option'] == "slideInLeft") {
                                            echo "selected=selected";
                                        }
                                        ?>>Left</option>
                                        <option value="slideInRight" <?php
                                        if ($row['slide_option'] == "slideInRight") {
                                            echo "selected=selected";
                                        }
                                        ?> >Right</option>
                                        <option value="sliceDown" <?php
                                        if ($row['slide_option'] == "sliceDown") {
                                            echo "selected=selected";
                                        }
                                        ?>>sliceDown</option>
                                        <option value="sliceDownLeft" <?php
                                        if ($row['slide_option'] == "sliceDownLeft") {
                                            echo "selected=selected";
                                        }
                                        ?>>sliceDownLeft</option>
                                        <option value="sliceUp" <?php
                                        if ($row['slide_option'] == "sliceUp") {
                                            echo "selected=selected";
                                        }
                                        ?>>sliceUp</option>
                                        <option value="sliceUpLeft" <?php
                                        if ($row['slide_option'] == "sliceUpLeft") {
                                            echo "selected=selected";
                                        }
                                        ?>>sliceUpLeft</option>
                                        <option value="sliceUpDown" <?php
                                        if ($row['slide_option'] == "sliceUpDown") {
                                            echo "selected=selected";
                                        }
                                        ?>>sliceUpDown</option>
                                        <option value="sliceUpDownLeft" <?php
                                        if ($row['slide_option'] == "sliceUpDownLeft") {
                                            echo "selected=selected";
                                        }
                                        ?>>sliceUpDownLeft</option>
                                        <option value="fold" <?php
                                        if ($row['slide_option'] == "fold") {
                                            echo "selected=selected";
                                        }
                                        ?>>fold</option>
                                        <option value="fade" <?php
                                        if ($row['slide_option'] == "fade") {
                                            echo "selected=selected";
                                        }
                                        ?>>fade</option>
                                        <option value="random" <?php
                                        if ($row['slide_option'] == "random") {
                                            echo "selected=selected";
                                        }
                                        ?>>random</option>
                                        <option value="boxRandom" <?php
                                        if ($row['slide_option'] == "boxRandom") {
                                            echo "selected=selected";
                                        }
                                        ?>>boxRandom</option>
                                        <option value="boxRain" <?php
                                        if ($row['slide_option'] == "boxRain") {
                                            echo "selected=selected";
                                        }
                                        ?>>boxRain</option>
                                        <option value="boxRainReverse" <?php
                                        if ($row['slide_option'] == "boxRainReverse") {
                                            echo "selected=selected";
                                        }
                                        ?>>boxRainReverse</option>
                                        <option value="boxRainGrow" <?php
                                        if ($row['slide_option'] == "boxRainGrow") {
                                            echo "selected=selected";
                                        }
                                        ?>>boxRainGrow</option>
                                        <option value="boxRainGrowReverse" <?php
                                        if ($row['slide_option'] == "boxRainGrowReverse") {
                                            echo "selected=selected";
                                        }
