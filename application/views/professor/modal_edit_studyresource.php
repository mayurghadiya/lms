                ...
                <div class="panel-body">
                    <div class="tab-pane box" id="add" style="padding: 5px">
                        <div class="box-content">  
                            ...
                            <?php echo form_open(base_url() . 'professor/studyresource/do_update/' . $row['study_id'], array('class' => 'form-horizontal form-groups-bordered validate', 'id' => 'frmeditstudyresource', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select name="degree" id="degree2" class="form-control"> 
                                        ...
                                        <option value="All" <?php if ($row['study_degree'] == "All") {
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <select name="course" id="course2"  class="form-control">
                                        ...
                                        <option value="All" <?php if ($row['study_course'] == "All") {
                                            echo "selected=selected";
                                        } ?> >All</option>
                                        <?php
                                        ...
                                        foreach ($course as $crs) {
                                            ?>
                                            <option value="<?php echo $crs->course_id; ?>" <?php if ($crs->course_id == $row['study_course']) {
                                        echo "selected='selected'";
                                    } ?> ><?= $crs->c_name ?></option>
        <?php
    }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <select name="batch" id="batch2"  class="form-control">
                                        ...
                                        <option value="All" <?php if ($row['study_batch'] == "All") {
        echo "selected=selected";
    } ?> >All</option>
                                        <?php
                            ...
                            <div class="form-group"> 
                                ...
                                <div class="col-sm-8">
                                    <select name="semester" id="semester2"  class="form-control">
                                        ...
                                        <option value="All" <?php if ($row['study_sem'] == "All") {
                                        echo "selected=selected";
                                    } ?> >All</option>
                                        <?php
...
<script type="text/javascript">
    ...
    $("#degree2").change(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url() . 'professor/get_courcestudy/'; ?>",
            data: dataString,
    ...
    $("#course2").change(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url() . 'professor/get_batchs/'; ?>",
            data: dataString,
            success: function (response) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url() . 'professor/get_semesterall/all'; ?>",
                    data: {'course': course},
                    success: function (response) {
