...
<!--            <div class=panel-heading>
            ...
            <div class="panel-body"> 
                ...
                <div class="box-content">  
                    ...
                    <?php echo form_open(base_url() . 'professor/library/create', array('class' => 'form-horizontal form-groups-bordered validate', 'role' => 'form', 'id' => 'frmlibrary', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                    <div class="padded">											
...
<script type="text/javascript">
    ...
    $("#degree").change(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url() . 'professor/get_cource/'; ?>",
            data: dataString,
    ...
    $("#course").change(function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url() . 'professor/get_semesterall/'; ?>",
                    data: {'course': course},
    ...
    function get_student2(batch, semester = '') {
        $.ajax({
            url: '<?php echo base_url(); ?>professor/batchwisestudent/',
            type: 'POST',
            data: {'batch': batch},
    ...
    function get_students2(sem)
    {
        ...
        var degree = $("#degree").val();
        $.ajax({
            url: '<?php echo base_url(); ?>professor/semwisestudent/',
            type: 'POST',
