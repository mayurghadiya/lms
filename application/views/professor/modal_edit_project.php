                ...
                <div class="panel-body">
                    <div class="tab-pane box" id="add" style="padding: 5px">
                        <div class="box-content">  
                            ...
                            <?php echo form_open(base_url() . 'professor/project/do_update/' . $row['pm_id'], array('class' => 'form-horizontal form-groups-bordered validate', 'id' => 'frmeditproject', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
...
<script type="text/javascript">
    ...
    $("#btnupd").click(function (event) {
        if ($("#degree2").val() != null & $("#course2").val() != null & $("#batch2").val() != null & $("#semester2").val() != null & $("#title2").val() != null)
        {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() . 'professor/checkprjectsedit/' . $param2; ?>",
                dataType: 'json',
                data:
                        {
                            'degree': $("#degree2").val(),
    ...
    function get_student(batch, semester = '') {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>professor/batchwisestudentcheckbox/' + param,
            type: 'POST',
    ...
    function get_students(divclass)
    {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>professor/checkboxstudent/' + param,
            type: 'POST',
    ...
    $("#degree2").change(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url() . 'professor/get_cource/project'; ?>",
            data: dataString,
            success: function (response) {
    ...
    $("#course2").change(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url() . 'professor/get_batchs/project'; ?>",
            data: dataString,
            success: function (response) {
