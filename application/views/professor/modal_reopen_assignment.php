...
$reopen_student = $this->Professor_model->get_student_reopen($param2);
?>
<?php
$existing = '';
            ...
            <div class="panel-body">
                <div class="tab-pane box" id="add" style="padding: 5px">
                    <div class="box-content">  
                        ...
                        <?php echo form_open(base_url() . 'professor/assignment/reopen/' . $param2, array('class' => 'form-horizontal form-groups-bordered validate', 'id' => 'frmeditproject', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                            ...
                            <div class="col-sm-8">
                                ...
                                <div id="student2" class="col-sm-8">
                                    ...
                                    foreach ($student_list as $rowstu) {
                                        $exists = $this->Professor_model->get_submitted_student($param2, $rowstu->std_id);
                                        ...
                                        if (empty($exists[0]->student)) {
                                            ...
                                            <div class="checkedstudent">
                                                ...
                                                if (!empty($existing)) {
                                                    if (in_array($rowstu->std_id, $existing)) {
                                                        echo "checked=checked";
                                                    }
                                                }
                                                ?> name="student[]" value="<?php echo $rowstu->std_id; ?>" onclick="uncheck();"  class="checkbox1" ><?php echo $rowstu->std_first_name . ' ' . $rowstu->std_last_name; ?>
                                            </div>
                                            <?php
                                        }
                                    }
