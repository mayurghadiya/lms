                            ...
                            <div class=mainnav>
                                <ul>
                                    ...
                                    <li class="hasSub<?php echo highlight_menu($page, $pages); ?>">
                                        ...
                                        <ul <?php echo navigation_show_hide_ul($page, $pages); ?>>
                                            <li>
                                                <a id="link-compose" href="<?php echo base_url(); ?>professor/email_compose">
                                                    <i class="s16 icomoon-icon-screen-2"></i>
                                                    <span class="txt">Compose</span>
                                                </a>
                                            </li> 
                                            <li>
                                                <a id="link-inbox" href="<?php echo base_url(); ?>professor/email_inbox">
                                                    <i class="s16 icomoon-icon-screen-2"></i>
                                                    <span class="txt">Inbox</span>
                                                </a>
                                            </li> 
                                            <li>
                                                <a id="link-sent" href="<?php echo base_url(); ?>professor/email_sent">
                                                    <i class="s16 icomoon-icon-screen-2"></i>
