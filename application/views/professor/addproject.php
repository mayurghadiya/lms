...
<script type="text/javascript">
    ...
    function get_student2(batch, semester = '') {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>professor/batchwisestudentcheckbox/',
            type: 'POST',
    ...
    function get_students2(divclass)
    {
        ...
        $.ajax({
            url: '<?php echo base_url(); ?>professor/checkboxstudent/',
            type: 'POST',
    ...
    $("#btnadd").click(function (event) {
        if ($("#degree").val() != null & $("#course").val() != null & $("#batch").val() != null & $("#semester").val() != null & $("#title").val() != null)
        {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url() . 'professor/checkprjects'; ?>",
                dataType: 'json',
                data:
                        {
                            'degree': $("#degree").val(),
                ...
                success: function (response) {
                    if (response.length == 0) {
                        $.ajax({
                            type: "POST",
                            url: "<?php echo base_url() . 'professor/checkprojectstd'; ?>",
                            data: {
                                'degree': $("#degree").val(),
                                'course': $("#course").val(),
                                'batch': $("#batch").val(),
