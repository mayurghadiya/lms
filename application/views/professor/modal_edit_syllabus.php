                ...
                <div class="panel-body">
                    <div class="tab-pane box" id="add" style="padding: 5px">
                        <div class="box-content">  
                            ...
                            <?php echo form_open(base_url() . 'professor/syllabus/do_update/' . $row['syllabus_id'], array('class' => 'form-horizontal form-groups-bordered validate', 'id' => 'frmeditsyllabus', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
                                ...
                                <div class="col-sm-5">
                                    <select name="degree" id="degree2" class="form-control">
                                        ...
                                        foreach ($degree as $dgr) {
                                            ...
                                            if ($row['syllabus_degree'] == $dgr->d_id) {
...
<script type="text/javascript">
    ...
    $("#degree2").change(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url() . 'professor/get_cource/edit'; ?>",
            data: dataString,
