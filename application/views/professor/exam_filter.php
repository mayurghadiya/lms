        ...
        foreach ($exams as $row) {
            ...
            <tr>
                ...
                <td class="menu-action">
                    ...
                    <a href="#" onclick="confirm_modal('<?php echo base_url(); ?>professor/exam/delete/<?php echo $row->em_id; ?>');" data-original-title="remove" data-toggle="tooltip" data-placement="top"><span class="label label-danger mr6 mb6">Delete</span></a>
                </td>
            </tr>
        <?php } ?>
    </tbody>
