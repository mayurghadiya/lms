    ...
    <div class=col-lg-12>
        ...
        <div class="panel-default toggle panelMove panelClose panelRefresh">
            ...
            <div class=panel-body>
                <form id="process_payment" class="form-horizontal form-groups-bordered validate" role="form" method="post" action="<?php echo base_url('student/authorize_net_make_payment'); ?>">
