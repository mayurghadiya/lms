    ...
    <div class=col-lg-12>
        ...
        <div class="panel panel-default toggle panelMove panelClose panelRefresh">
            ...
            <div class="panel-body">
                ...
                <form id="process_payment" class="form-horizontal form-groups-bordered validate" role="form" method="post" action="<?php echo base_url('student/vocational_authorize_net_make_payment'); ?>">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#card_number').on('blur', function () {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>student/verify_card_detail/' + card_number,
                type: 'post',
