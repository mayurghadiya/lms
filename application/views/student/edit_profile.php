                ...
                <div class="row profile">
                    ...
                    <div class=col-md-4>
                        <div class=profile-avatar>
                            ...
                            <img alt="" src="<?php echo $profile_pic; ?>" width="128" height="128" id="manage_profile">
                        <?php } else { ?>
                            <img alt="example image" width="128" height="128" src="<?php echo base_url('uploads/user.jpg'); ?>" id="manage_profile"> </div>
                    <?php } ?>
...
<div class="col-lg-6 col-md-6 col-sm-12">
    ...
    <div class="tabs mb20">
        ...
        <div id=myTabContent class=tab-content>
            <div class="tab-pane fade active in" id=change-passowrd>
                <?php
